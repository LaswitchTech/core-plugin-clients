...
<script>
    $(document).ready(function(){
        $.ajax({
            url: '/endpoint.php/clients/details?id=<?= $this->Request->getParams('GET', 'id') ?>',
            ...
            success: function(response) {
                ...
                const Details = builder.Component(
                    ...
                    {
                        icon: "buildings",
                        title: response.record.vcard.name + " - <small>"+builder.Locale.get('Client')+"</small>",
                    },
                    function(card,component){
                        ...
                        //     'data-action': 'wave',
                        //     'data-relationship': '{"clients": "' + response.record.id + '"}',
                        ...
                        if(response.record.isArchived === 0){
                            ...
                            component.body.controls.archive.click(function(){
                                ClientModalArchive(response.record);
                            });
                        }
                ...
                const Tabs = builder.Component(
                    ...
                    function(tabs,card){
                        ...
                        tabs.add(
                            ...
                            function(tab,nav){
                                card.notes = tab;
                                NotesFeed(response.record.notes, tab, 'clients', response.record.id);
                            },
                        );
                        tabs.add(
                            'contacts',
                        ...
                        tabs.add(
                            ...
                            function(tab,nav){
                                ...
                                docvals = {
                                    "locale": response.record.vcard.locale,
                                    "avatar": "/plugins/clients/logo?id="+response.record.id,
